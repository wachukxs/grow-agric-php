...
// THERE IS A BUG HERE, FOR SOME REASON, THE REQUEST IS MADE TWICE!!! [Caused by pre-flight request]
...
file_put_contents('php://stderr', print_r("\n\n" . 'Checking origin ' . $origin . ' for CORS access' . "\n", TRUE)); // or var_export($foo, true)
            ...
            if ($result) { // check that $result is an int
                ...
                if (is_array($row)) { // gettype($row) == "array"
                    ...
                    $farmer_details_arr = array(
                        ...
                        'id' => $farmerid, // should rename to farmer_id later
